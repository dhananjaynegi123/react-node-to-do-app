...
const Register = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        var reg= /^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.* ).{8,16}$/
        
        if(reg.test(password)==false){
            showAlert('Please check password policy', 'alert-error');
            return;
        }
        if (password !== confirm) {
        ...
        <div className="form-login">
            ...
            <div className="form-container dark-shadow">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <label style={{color: "red"}} htmlFor="confirm">password must contain at least eight characters, at least one number and both lower and uppercase letters and special characters</label>
                    <br/><br/>
                    <div className="form-field">
